...
const translations = {
  ar: {
    ...
    monthlyOpenBtn: "فتح",
    monthlyEditBtn: "تعديل",
    monthlySaveBtn: "حفظ",
    monthlySchoolRenamed: "تم تعديل اسم المدرسة.",
    ...
    btnFixUnmatchedNames: "🔧 مطابقة الأسماء غير المطابقة",
    nameMatchingHeading: "مطابقة أسماء المدارس مع القالب",
    nameMatchingHint: "لكل مدرسة أدناه، اربطيها بمدرسة موجودة عندك (يتم تعديل اسمها ليطابق القالب) أو أضيفيها كمدرسة جديدة.",
    nameMatchingAllDone: "تمت مطابقة كل الأسماء 🎉",
    nameMatchingSelectPlaceholder: "-- اختاري مدرسة من قائمتك لربطها بهذا الاسم --",
    nameMatchingAddNewOption: "➕ إضافة كمدرسة جديدة بهذا الاسم",
    nameMatchingApplyBtn: "تطبيق",
    nameMatchingNeedSelection: "اختاري مدرسة أو \"إضافة كمدرسة جديدة\" أولًا.",
    nameMatchingApplied: "تم الربط.",
    ...
    monthlyDocumentPhotosLabel: "توثيق الصور (إضافة اسم المدرسة والتاريخ على الصور)",
    monthlyDocumentPhotosHint: "أوقفيه لو هذي المدرسة موثّقة أساسًا من مكان آخر — الصور تبقى بدون أي إضافات.",
    monthlyBasicSectionTitle: "📸 الصور الشهرية الأساسية",
    monthlyAcSectionTitle: "❄️ صور التكييف",
    monthlyStepOf: (n, total) => `القسم ${n} من ${total}`,
    monthlyBackToBasicSection: "‹ رجوع للقسم الأول",
    monthlyGoToAcSection: "قسم التكييف ›",
  ...
  en: {
    ...
    monthlyEditBtn: "Edit",
    monthlySaveBtn: "Save",
    monthlySchoolRenamed: "School name updated.",
    ...
    btnFixUnmatchedNames: "🔧 Fix unmatched names",
    nameMatchingHeading: "Match school names to the template",
    nameMatchingHint: "For each school below, link it to an existing school of yours (its name will be updated to match the template) or add it as new.",
    nameMatchingAllDone: "All names matched 🎉",
    nameMatchingSelectPlaceholder: "-- Pick a school of yours to link to this name --",
    nameMatchingAddNewOption: "➕ Add as a new school with this name",
    nameMatchingApplyBtn: "Apply",
    nameMatchingNeedSelection: "Pick a school, or \"Add as new\" first.",
    nameMatchingApplied: "Linked.",
    btnRecheck: "Recheck",
    ...
    monthlyDocumentPhotosLabel: "Document photos (burn school name + date onto photos)",
    monthlyDocumentPhotosHint: "Turn this off if this school is already documented from elsewhere -- photos stay untouched.",
    monthlyBasicSectionTitle: "📸 Basic Monthly Photos",
    monthlyAcSectionTitle: "❄️ AC Photos",
    monthlyStepOf: (n, total) => `Section ${n} of ${total}`,
    monthlyBackToBasicSection: "‹ Back to basic section",
    monthlyGoToAcSection: "AC section ›",
